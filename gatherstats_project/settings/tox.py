"""
The :py:mod:`gatherstats_project.settings_testsuite` module contains settings which are
...
#: when running tests.
TEST_RUNNER = 'gatherstats_project.test.runner.BufferedDiscoverRunner'
